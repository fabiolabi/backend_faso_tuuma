...
public class AuthController {
    ...
    @Operation(summary = "Demande d'un code de réinitialisation de mot de passe (envoyé par email)")
    ...
    @Operation(summary = "Confirmation de la réinitialisation avec le code reçu")
