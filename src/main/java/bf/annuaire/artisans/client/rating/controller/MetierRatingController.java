...
@Tag(name = "Notation commerce", description = "Avis des clients sur les commerces")
public class MetierRatingController {

    private final MetierRatingService ratingService;

    @Operation(summary = "Avis publics (approuvés) d'un commerce, paginés")
    ...
    @Operation(summary = "Déposer ou mettre à jour mon avis sur un commerce (CLIENT)")
    ...
    @Operation(summary = "Supprimer mon avis sur un commerce (CLIENT)")
    ...
    @Operation(summary = "Mes avis sur les commerces")
